...
const ChangeLogPanel = () => {
  ...
  return (
    <div className="card changelog" id="changelog">
      <div className="card-body">
        ...
        <div className="card-text">
          ...
          <ul>
            <li>
              Added 3 new maps. Including Remastered Immersive Farm 2. Big
              thanks to{" "}
              <a
          ...
          <ul>
            ...
            <li>
              ...
              extracting exact restriction areas for any maps (including custom
              ones). Once this is ready, planner will have 1:1 exact placement
              information
            </li>
          </ul>
          <b>6th Nov 2018</b>
          ...
          <ul>
            ...
            <li>
              There is now a list of <a href="#patrons">Patrons</a>. You can get
            ...
            <li>
              Made visible changelog shorter. You can still view all of it by
              clicking the "Show more" link at the bottom of this box.
            </li>
          </ul>
          <b>9th Oct 2017</b>
          <ul>
            <li>
              Finally did the RethinkDB to MySQL migration. If you wish to read
          ...
          <ul>
            <li>
              Fixed saving map to picture. Thanks Stefanie Carter for reporting
              this.
            </li>
          </ul>
          <b>25th Aug 2017</b>
          ...
          <ul>
            ...
            <li>
              Changed how layout changing works. If you have any problems with
          ...
          <ul>
            ...
            <li>
              Added facebook button so people would find our FB group more
              easily
            </li>
          </ul>
          {ShowMore && (
            <div>
              ...
              <ul>
                <li>
                  Placing torch on fence block will now turn it into
                  torch-fence.
                </li>
              ...
              <ul>
                <li>
                  Testing Ads as donations do not currently cover server
                  upkeeps.
                </li>
              </ul>
              <b>24th Oct</b>
              ...
              <ul>
                ...
                <li>
                  Added new buildings (obelisks, mill, shed, junimo hut, gold
                  clock)
                </li>
              ...
              <ul>
                <li>
                  Added new farm layout and made it possible to support custom
                  maps too
                </li>
              ...
              <ul>
                ...
                <li>
                  Moved the server to US (NYC-3). Sorry EU users, but as most of
                  the users are from US, it made more sense to have the server
                  there
                </li>
              ...
              <ul>
                ...
                <li>
                  Added /api/import endpoint which can be use to integrate
              ...
              <ul>
                ...
                <li>
                  Added freemode possibility for the brush. Enable it in the
                  options (this option does not save over reloads)
                </li>
              ...
              <ul>
                ...
                <li>
                  Highlights should be better now, also they are off by default
                  now
                </li>
              ...
              <ul>
                ...
                <li>
                  A lot more optimized way of drawing the SVG (using patterns
                  and use elements)
                </li>
              </ul>
            </div>
          ...
          >
            {!ShowMore ? "Show more changelog..." : "Show less changelog..."}{" "}
          </button>
        </div>
      </div>
    </div>
